...
public:
    ...
    MixingEngineService(const MixingEngineService& other) = delete; //COPY-CONSTRUCTOR IS DELETED SINCE WE DON'T WANT IT
    MixingEngineService& operator=(const MixingEngineService& other) = delete; //COPY-ASSIGNMENT IS DELETED SINCE WE DON'T WANT IT
